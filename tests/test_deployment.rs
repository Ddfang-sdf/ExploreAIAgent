...
use explore_ai_agent::common::config::{AppConfig, DeepExplorerConfig, FastExploreConfig};
...
fn make_orchestrator() -> Orchestrator {
    Orchestrator::new(make_adapter(), make_registry(), make_conversation_manager(), DeepExplorerConfig::default(), FastExploreConfig::default())
}
